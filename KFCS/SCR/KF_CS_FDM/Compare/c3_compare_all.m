...
mean_error_1 = mean(error_1(20:end));
mean_error_2 = mean(error_2(20:end));
mean_error_3 = mean(error_3(20:end));
mean_error_4 = mean(error_4(20:end));
mean_error_5 = mean(error_5(20:end));

t = 0 : Dt : 20;
figure
plot(t(20:end),error_1(20:end),'r-','LineWidth',5)
hold on
plot(t(20:end),error_2(20:end),'b-','LineWidth',5)
hold on
plot(t(20:end),error_3(20:end),'g-','LineWidth',5)
hold on
plot(t(20:end),error_4(20:end),'c-','LineWidth',5)
hold on
plot(t(20:end),error_5(20:end),'m-','LineWidth',5)
hold on
plot(t(20:end),ones(length(t(20:end)))*mean_error_1,'r-.','LineWidth',2)
hold on
plot(t(20:end),ones(length(t(20:end)))*mean_error_2,'b-.','LineWidth',2)
hold on
plot(t(20:end),ones(length(t(20:end)))*mean_error_3,'g-.','LineWidth',2)
hold on
plot(t(20:end),ones(length(t(20:end)))*mean_error_4,'c-.','LineWidth',2)
hold on
plot(t(20:end),ones(length(t(20:end)))*mean_error_5,'m-.','LineWidth',2)
hold on
