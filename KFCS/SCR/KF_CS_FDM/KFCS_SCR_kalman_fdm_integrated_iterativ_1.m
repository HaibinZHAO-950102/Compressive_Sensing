...
for n = 1 : 0.5/Dt : nt
    ...
    name = ['CS_SCR_KF_FDM_integrated_iterativ_1.gif'];
    if printfigure == 1
        if n==1
...
f_e_scr_kf_fdm_integrated_iterativ_1 = f_e_integrated_1;
save('f_e_scr_kf_fdm_integrated_iterativ_1.mat','f_e_scr_kf_fdm_integrated_iterativ_1')
