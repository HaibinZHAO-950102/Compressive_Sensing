...
load f_e_wt_kf_modal_dg
load f_e_wt_kf_modal_integrated_1
load Messwerte

Dt = 0.1;

f = f(:,1:Dt/dt:end);
f1 = f_e_wt_kf_modal_01_dg;
f2 = f_e_wt_kf_modal_integrated_1;

NAME = 'comapre KFCS_dg and KFCS_integrated';
l1 = 'KFCS dynamic weight';
l2 = 'KFCS integrated';
