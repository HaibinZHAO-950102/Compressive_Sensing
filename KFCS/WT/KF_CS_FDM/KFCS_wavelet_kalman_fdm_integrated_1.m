...
for t = 2 : nt
    ...
    z(:, t) = WT * Phi_KF * f_e_integrated_1(:,t);
end
...
for n = 1 : 0.5/Dt : nt
    ...
    name = ['CS_wavelet_KF_FDM_integrated_1.gif'];
    if printfigure == 1
        if n==1
...
f_e_wt_kf_fdm_integrated_1 = f_e_integrated_1;
save('f_e_wt_kf_fdm_integrated_1.mat','f_e_wt_kf_fdm_integrated_1')
