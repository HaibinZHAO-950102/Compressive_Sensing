...
setplt('Coeffcients of Temperature with SCR','$z$','Value','Coeffcients of Temperature with SCR',printfigure)
...
T = text(800,25,txt,'FontSize',30);
set(T,'Interpreter','latex')
setplt('K-term Coeffcients of Temperature with SCR','$z$','Value','K-term Coeffcients of Temperature with SCR',printfigure)
...
set(T,'Interpreter','latex')
setplt('Tempreature Distribution','$x$','$f$','K-term Approximation SCR',printfigure)
...
xlim([0 10])
ylim([0 2])
setplt('Recovered Signal by CS','$x$','$f$','Recovered Signal by CS SCR',printfigure)
