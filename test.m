...
k = 0.1; % W?rmeleitf?higkeit in cm^2/s
...
for n = 1 : 5 : N_time
    ...
    if n==1
         imwrite(imind,cm,'TV_inhomo_modal_3.gif','gif', 'Loopcount',inf,'DelayTime',1e-6);
    else
         imwrite(imind,cm,'TV_inhomo_modal_3.gif','gif','WriteMode','append','DelayTime',1e-6);
    end
end
...
save('Messwerte_1.mat','m','p','step_time','k','Length')
