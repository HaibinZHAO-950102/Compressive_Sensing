...
%                 name = [num2str(kkk),'_',num2str(iii),'_',num2str(jjj),'.gif'];
%                 if printfigure == 1
%                     if n==1
...
%             end
% 
%             name = [num2str(kkk),'_',num2str(iii),'_',num2str(jjj),'.png'];
% 
%             figure
%             [X, Y] = meshgrid(x, t);
%             mesh(X,Y,f_mu)
%             setmesh('Tempreature Distribution','$x$','$t$','$f$',name,printfigure)
            ...
            name = [num2str(kkk),'_',num2str(iii),'_',num2str(jjj),'.mat'];
